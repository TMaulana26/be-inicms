...
class RouteServiceProvider extends ServiceProvider
{
    ...
    protected function mapApiRoutes(): void
    {
        ...
        // Direct flat /api/skills route mapping for frontend integration
        Route::middleware('api')->prefix('api')->name('api.')->group(function () {
            Route::get('skills', [\Modules\Skill\Http\Controllers\SkillController::class, 'index'])->name('skills.public-index');
        });
    }
}
